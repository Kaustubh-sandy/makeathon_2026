...
export default function AnnouncementPopup() {
    ...
    return (
        ...
        >
            {/* Popup Card */}
            <div className="relative overflow-hidden rounded-none border border-white/12 bg-[#001018] shadow-[0_8px_40px_rgba(24,184,218,0.12),0_0_0_1px_rgba(24,184,218,0.06)]">
                {/* Accent top bar */}
                <div className="absolute top-0 left-0 h-0.5 w-full bg-linear-to-r from-transparent via-[#18B8DA] to-transparent" />

                {/* Close button */}
                <button
                    onClick={handleClose}
                    className="absolute top-3 right-3 z-10 flex h-7 w-7 items-center justify-center rounded-none border border-white/10 bg-white/5 text-white/50 transition-all duration-200 hover:border-white/25 hover:bg-white/10 hover:text-white"
                ...
                <div className="p-5 pr-12">
                    ...
                    <div className="mb-3 flex items-center gap-2.5">
                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-none border border-[#18B8DA]/20 bg-[#18B8DA]/10">
                    ...
                    {/* Divider */}
                    <div className="mb-3 h-px w-full bg-linear-to-r from-[#18B8DA]/30 via-white/10 to-transparent" />
                    ...
                    <button
                        onClick={handleClose}
                        className="mt-4 w-full rounded-none border border-[#18B8DA]/30 bg-[#18B8DA]/10 px-4 py-2.5 text-xs font-bold uppercase tracking-[0.2em] text-[#18B8DA] transition-all duration-300 hover:border-[#18B8DA]/50 hover:bg-[#18B8DA]/20 hover:shadow-[0_0_20px_rgba(24,184,218,0.15)]"
                    >
                        Got it
                    </button>
                </div>
