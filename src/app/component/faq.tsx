...
export default function FAQSection() {
  ...
  const faqData = useMemo<FAQ[]>(() => [
    ...
    },
    {
      ...
      answer: "Yes, inter-college teams are allowed. If a team includes any VIT campus student, the registration must be submitted by the VIT student. External participants in the team will be required to pay the registration fee if shortlisted.",
      tags: ["team", "collaboration", "cross-college", "registration"],
    },
    {
      id: "TECH-002",
      category: "technical",
      question: "Will hardware components be provided?",
      answer: "Yes, all required basic components will be provided by the organizers. Participants are also allowed to bring and use their own components if they prefer.",
      tags: ["hardware", "components", "resources", "bring-own"],
    },
    {
      id: "GEN-005",
      category: "general",
      question: "How much do we need to pay?",
      answer: "Only external (non-VIT) participants are required to pay the registration fee after shortlisting. VIT students are not required to pay.",
      tags: ["fees", "cost", "registration", "shortlisting"],
    },
    {
      id: "LOG-002",
      category: "logistics",
    ...
    },
    {
      id: "TECH-006",
      category: "technical",
      question: "Is this hackathon only for hardware projects?",
      answer: "No. Participants can build pure hardware projects, pure software projects, or integrated hardware + software solutions. All formats are accepted.",
      tags: ["project-type", "hardware", "software", "integration"],
    },
    {
      id: "TECH-007",
      category: "technical",
      question: "Can we bring a project that we have already built?",
      answer: "No. Projects must be developed during the hackathon. Pre-built or previously completed projects are not allowed.",
      tags: ["rules", "project", "pre-built"],
    },
    {
      id: "LOG-005",
      category: "logistics",
      question: "Do we need to submit a working prototype initially?",
      answer: "No. For the shortlisting round, only documentation is required. There is no fixed template, but it should clearly include: Problem Statement, Proposed Solution, Technical Approach, Architecture / Block Diagram, and Expected Impact.",
      tags: ["submission", "shortlisting", "documentation", "prototype"],
    },
  ], []);
